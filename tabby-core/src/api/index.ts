...
export { WorkspaceComponent, SplitContainer, SplitDirection, SplitOrientation } from '../components/workspace.component'
/** @deprecated Renamed to WorkspaceComponent — kept for plugins still using the old name */
export { SplitTabComponent } from '../components/workspace.component'
...
export { MenuProvider, AppMenu, AppMenuItem } from './menuProvider'
...
export { SidebarContribution, SidebarContributionKind, SidebarContext } from './sidebarContribution'
export { ProfileTreeItemProvider, ProfileTreeItemContext } from './profileTreeItemProvider'
export { TabContextMenuItemProvider } from './tabContextMenuProvider'
export { SelectorOption } from './selector'
export { CLIHandler, CLIEvent } from './cli'
export { PlatformService, ClipboardContent, MessageBoxResult, MessageBoxOptions, FileDownload, FileUpload, FileTransfer, HTMLFileUpload, FileUploadOptions, DirectoryUpload, DirectoryDownload, PlatformTheme, ProxyTestResult } from './platform'
...
export { Action, ActionContext, ActionProvider, AsyncActionProvider, ActionSurface } from './action'
export { actionsToMenuItems } from './adapters'
export { ActionRegistry } from '../services/action.service'
export { SessionService } from '../services/session.service'
export { SessionTab } from './session'
export { IPCConnectionProxy } from './ipcConnectionProxy'
export { TopLevelTab } from './topLevelTab'
export { ProfileEditHost, EditProfileOptions, EditProfileGroupResult } from './profileEditHost'
export { ConfigService, configMerge, ConfigProxy, ProxifiedConfig, FullyDefined } from '../services/config.service'
export { DockingService, Screen, DockSide } from '../services/docking.service'
