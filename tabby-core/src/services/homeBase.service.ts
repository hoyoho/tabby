...
export class HomeBaseService {
    ...
    openGitHub (): void {
        this.platform.openExternal('https://github.com/hoyoho/tabby')
    }
    ...
    reportBug (): void {
        ...
        this.platform.openExternal(`https://github.com/hoyoho/tabby/issues/new?body=${encodeURIComponent(body)}`)
    }
}
